...
import { Building2, CalendarDays, CheckCircle2, Clock3, Mail, Phone, XCircle } from "lucide-react";
      ...
      return (
        <div className="flex min-w-[230px] items-center gap-3">
          <div className="relative flex h-10 w-10 shrink-0 items-center justify-center overflow-hidden rounded-lg border bg-muted">
            {enterprise.logo ? (
              <Image src={enterprise.logo} alt="" fill sizes="40px" className="object-cover" />
            ) : (
